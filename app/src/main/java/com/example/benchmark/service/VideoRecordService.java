...
public class VideoRecordService extends Service {
        ...
        public void handleMessage(@NonNull Message msg) {
            switch (msg.what) {
                ...
                case STOP_RECORD:
                    ...
                    // 点击结束录制后休息1s后才能继续录制  Click Finish
                    // recording and rest for 1 second before continuing recording
                    isAble = false;
                    stopRecord();
    ...
    private void initFloatView() {
        ...
        // the upper left corner of the screen as the origin,  set the initial value of x and y
