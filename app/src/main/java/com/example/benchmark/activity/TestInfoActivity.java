...
public class TestInfoActivity extends AppCompatActivity {
    ...
    private String hardwareInfo(String text) {
        ...
        for (int i = 0; i < rom.size(); i++) {
            ...
            if (object instanceof Map) {
                map = (Map) object;
                str = textSet5(str, map);
            }
            object = ram.get(i);
            if (object instanceof Map) {
                map = (Map) object;
                str = textSet6(str, map);
            }
            object = cpu.get(i);
            if (object instanceof Map) {
                map = (Map) object;
                str = textSet7(str, map);
                object = gpu.get(i);
                map = (Map) object;
                str = textSet8(str, map);
            }
        }
        return str;
    }
    ...
    private String textSet8(String text, Map map) {
        String str = text;
        str += "GPU" + System.getProperty("line.separator");
        str += "    gpuVendor: " + (map.get("gpuRender") == null
                ? "null" : map.get("gpuRender").toString())
                + System.getProperty("line.separator");
        str += "    gpuVersion: " + (map.get("gpuVersion") == null
                ? "null" : map.get("gpuVersion").toString())
                + System.getProperty("line.separator");
        str += "    gpuVendor: " + (map.get("gpuVendor") == null
                ? "null" : map.get("gpuVendor").toString())
                + System.getProperty("line.separator");
        str += "测试时间: " + (map.get("time") == null
    ...
    private String textSet7(String text, Map map) {
        String str = text;
        str += "CPU" + System.getProperty("line.separator");
        str += "    核数: " + (map.get("cores") == null
    ...
    private String textSet6(String text, Map map) {
        String str = text;
        str += "RAM" + System.getProperty("line.separator");
        str += "    可用内存: " + (map.get("availableRam") == null
                ? "null" : map.get("availableRam").toString())
                + System.getProperty("line.separator");
        str += "    总内存: " + (map.get("totalRam") == null
    ...
    private String textSet5(String text, Map map) {
        String str = text;
        str += "测试平台： " + (map.get("platformName") == null
                ? "null" : map.get("platformName").toString())
                + System.getProperty("line.separator");
        str += "ROM" + System.getProperty("line.separator");
        str += "    可用内存: " + (map.get("availableRom") == null
                ? "null" : map.get("availableRom").toString())
                + System.getProperty("line.separator");
        str += "    总内存: " + (map.get("totalRom") == null
    ...
    private String textSet4(String text, Map map) {
        ...
        str += "测试平台： " + (map.get("platformName") == null
                ? "null" : map.get("platformName").toString())
                + System.getProperty("line.separator");
        str += "    分辨率: " + (map.get("resolution") == null
                ? "null" : map.get("resolution").toString())
                + System.getProperty("line.separator");
        str += "    音画同步差: " + (map.get("maxDiffValue") == null
                ? "null" : map.get("maxDiffValue").toString())
                + System.getProperty("line.separator");
        str += "    PESQ: " + (map.get("pesq") == null
                ? "null" : map.get("pesq").toString())
                + System.getProperty("line.separator");
        str += "    SSIM: " + (map.get("ssim") == null
                ? "null" : map.get("ssim").toString())
                + System.getProperty("line.separator");
        str += "    PSNR: " + (map.get("psnr") == null
                ? "null" : map.get("psnr").toString())
                + System.getProperty("line.separator");
        str += "    评分: " + (map.get("qualityScore") == null
    ...
    private String testSet3(String text, Map map) {
        ...
        str += "测试平台： " + (map.get("platformName") == null
                ? "null" : map.get("platformName").toString())
                + System.getProperty("line.separator");
        str += "    正确率: " + (map.get("touchAccuracy") == null
                ? "null" : map.get("touchAccuracy").toString())
                + System.getProperty("line.separator");
        str += "    点击时延: " + (map.get("touchTimeDelay") == null
                ? "null" : map.get("touchTimeDelay").toString())
                + System.getProperty("line.separator");
        str += "    评分: " + (map.get("touchScore") == null
    ...
    private String textSet2(String text, Map map) {
        ...
        str += "测试平台： " + (map.get("platformName") == null
                ? "null" : map.get("platformName").toString())
                + System.getProperty("line.separator");
        str += "    启动成功率: " + (map.get("startSuccessRate") == null
                ? "null" : map.get("startSuccessRate").toString())
                + System.getProperty("line.separator");
        str += "    平均启动时间: " + (map.get("averageStartTime") == null
                ? "null" : map.get("averageStartTime").toString())
                + System.getProperty("line.separator");
        str += "    平均退出时间: " + (map.get("averageQuitTime") == null
                ? "null" : map.get("averageQuitTime").toString())
                + System.getProperty("line.separator");
        str += "    评分: " + (map.get("stabilityScore") == null
    ...
    private String textSet1(String text, Map map) {
        ...
        str += "测试平台： " + (map.get("platformName") == null
                ? "null" : map.get("platformName").toString())
                + System.getProperty("line.separator");
        str += "    平均帧率: " + (map.get("averageFps") == null
                ? "null" : map.get("averageFps").toString())
                + System.getProperty("line.separator");
        str += "    低帧率: " + (map.get("lowFrameRate") == null
                ? "null" : map.get("lowFrameRate").toString())
                + System.getProperty("line.separator");
        str += "    抖动方差: " + (map.get("frameShakeRate") == null
                ? "null" : map.get("frameShakeRate").toString())
                + System.getProperty("line.separator");
        str += "    jank次数: " + (map.get("jankCount") == null
                ? "null" : map.get("jankCount").toString())
                + System.getProperty("line.separator");
        str += "    帧间隔: " + (map.get("frameInterval") == null
                ? "null" : map.get("frameInterval").toString())
                + System.getProperty("line.separator");
        str += "    卡顿占比时长: " + (map.get("stutterRate") == null
                ? "null" : map.get("stutterRate").toString())
                + System.getProperty("line.separator");
        str += "    评分: " + (map.get("fluencyScore") == null
